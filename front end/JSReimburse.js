...
document.getElementById("getEmployeeButton").addEventListener("click", getUsername);
console.log("hi");
...
async function getUsername() {
    ...
    if(response.status === 200) { //"if the response has a status code of 200..."
        ...
        for(let employee of data){
            ...
            cell4.innerHTML = user.role.u_role;
...
let userp = document.getElementById("psword").value;
...
if(response.status === 202){
    ...
    document.getElementById("loginRow").innerText="Welcome " + data.fname + "!!";
